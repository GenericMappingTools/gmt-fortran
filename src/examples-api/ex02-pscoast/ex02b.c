...
int main() {
	...
	v=GMT_Create_Data(API,GMT_IS_VECTOR,GMT_IS_LINE,0,dim,NULL,NULL,0,0,NULL);
	printf("Create_Data: %c\n",v!=NULL?'T':'F');
	v2=GMT_Create_Data(API,GMT_IS_VECTOR,GMT_IS_POINT,0,dim,NULL,NULL,0,0,NULL);
	printf("Create_Data: %c\n",v2!=NULL?'T':'F');
	...
	printf("Call_Module: %s %d\n","psxy",ierr);
	*/
	printf("...line plotting skipped (GMT 5.1.1 segfault)\n");
