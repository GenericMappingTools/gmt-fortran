...
integer i,id,ierr,mode

! GMT time information format
mode=GMT_TIME_NONE ! GMT_TIME_NONE=0,GMT_TIME_CLOCK=1,GMT_TIME_ELAPSED=2
...
call sGMT_Message(mode=mode,format=message)
...
write (message,"(a,i2)") "Destroy_Session: ",ierr
