...
! GMT_Register_IO, sGMT_Init_IO, GMT_Get_Data and sGMT_Encode_ID
! ----------------------------------------------------------------------
...
id=GMT_Register_IO(family=GMT_IS_DATASET,method=GMT_IS_FILE,geometry=GMT_IS_POINT,resource=filedat)
call sGMT_Init_IO()
D=GMT_Get_Data(object_ID=id,err=ierr)
print *,"Get_Data: ",ierr
...
id2=GMT_Register_IO(family=GMT_IS_DATASET,method=GMT_IS_REFERENCE,geometry=GMT_IS_POINT,direction=GMT_IN,resource=D)
! id2=GMT_Get_ID(family=GMT_IS_DATASET,direction=GMT_IN,resource=D)
call sGMT_Encode_ID(string=filedat,object_ID=id2)
print *,"Register and Encode_ID: ",id2,filedat
